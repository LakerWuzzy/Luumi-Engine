			...
			case 'HouseWuz':
				{
						...
						var yo:FlxSprite = new FlxSprite().loadGraphic(Paths.image('stages/Carioquinha'));
						yo.scale.set(2.25, 2.25);
		                yo.antialiasing = true;
		                yo.active = false;
		                add(yo);
		
						var yeba:FlxSprite = new FlxSprite().loadGraphic(Paths.image('stages/Bruzih'));
						yeba.scale.set(2.25, 2.25);
		                yeba.antialiasing = true;
		                yeba.active = false;
		                add(yeba);
		
						var yup:FlxSprite = new FlxSprite().loadGraphic(Paths.image('stages/MESAWOOOOW'));
						yup.scale.set(2.25, 2.25);
		                yup.antialiasing = true;
		                yup.active = false;
		                add(yup);
				}
				case 'stage':
